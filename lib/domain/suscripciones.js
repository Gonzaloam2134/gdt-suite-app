 ...
 * prueba activa cuya fecha ya pasó, en cuyo caso se trata como suspendida.
 * Nunca escribe nada: es una lectura derivada.
 *
...
export const estadoEfectivo = (suscripcion, hoy = hoyISO()) => {
  ...
  return {
    estado: venciendoAhora ? 'suspended' : suscripcion.estado,
