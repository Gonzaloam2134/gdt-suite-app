...
/**
 * Dirección del local, pedida recién cuando el dueño decide conectar
 * Mercado Pago (no en el alta del local — ver Fase A del plan de MP del
 * cliente). lat/long quedan null si el navegador rechazó el permiso de
 * geolocalización: no bloquea la conexión, se completa con lo que haya.
 */
export const setDireccionLocal = (id, { direccion, ciudad, provincia, codigoPostal, latitud, longitud }) =>
  supabase.from('locales').update({
