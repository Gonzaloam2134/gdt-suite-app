...
export default function Reportes() {
  ...
  const loadReportes = async () => {
    try {
      ...
      const primerDiaMesAnterior = new Date(hoy.getFullYear(), hoy.getMonth() - 1, 1).toISOString().split('T')[0]
      ...
      const { data: currentMonthTx } = await supabase
        ...
        .lte('creado_en', ultimoDiaMes + 'T23:59:59')
      ...
      const { data: lastMonthTx } = await supabase
        ...
        .lte('creado_en', ultimoDiaMesAnterior + 'T23:59:59')
