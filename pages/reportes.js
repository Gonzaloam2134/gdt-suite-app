...
export default function Reportes() {
  ...
  try {
    ...
    // NUEVO: Función para aplicar formato de fecha
    ...
    applyDateFormat(wsVentas, 2, lastRowVentas - 1, 0) // NUEVO: Formato fecha columna A
    ...
    applyDateFormat(wsCompras, 2, lastRowCompras - 1, 0) // NUEVO: Formato fecha columna A
    ...
    calendarSorted.forEach(c => {
      ...
      // NUEVO: Guardar fecha como objeto Date en lugar de string
    ...
    applyDateFormat(wsCalendar, 2, lastRowCalendar, 0) // NUEVO: Formato fecha columna A
